...
export const ar = {
    ...
    'controls.removeLastItem': 'إزالة العنصر الأخير',
    'controls.removeRandomItem': 'إزالة عنصر عشوائي',
    'controls.pinning': 'التثبيت',
    'controls.pinRandomItem': 'تثبيت عنصر عشوائي',
    'controls.unpinAllItems': 'إلغاء تثبيت الكل',
    'controls.visibility': 'الرؤية',
    'controls.hideRandomItem': 'إخفاء عنصر عشوائي',
    'controls.unhideAllItems': 'إظهار كل العناصر',
