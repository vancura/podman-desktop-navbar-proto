...
export const he = {
    ...
    // Tooltips
    'tooltip.shortcut': 'קיצור',

    // Modal dialog
    'modal.hideItem': 'הסתר פריט',
    'modal.hideItemDescription': 'פריט זה יוסתר משורת הניווט. תוכל לשחזר אותו מהגדרות Podman Desktop.',
    ...
    'controls.removeLastItem': 'הסר פריט אחרון',
    'controls.removeRandomItem': 'הסר פריט אקראי',
    'controls.pinning': 'הצמדה',
    'controls.pinRandomItem': 'הצמד פריט אקראי',
    'controls.unpinAllItems': 'הסר הצמדה מהכל',
    'controls.visibility': 'נראות',
    'controls.hideRandomItem': 'הסתר פריט אקראי',
    'controls.unhideAllItems': 'הצג את כל הפריטים',
